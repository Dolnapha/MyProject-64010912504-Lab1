...
class ProductsController extends Controller
{
    ...
    {
        $data = Products::where('p_id', $id)->get();
    ...
    public function showAllWithImage()
    {
        ...
        foreach ($products as $value) {
          ...
          if($value->p_img != null) {
            $products[$i]['p_img'] = urlencode("http://".$ip_server."/foodapp/img/".$value->p_img);
        }
          $i++;
        }
    ...
    public function showOneWithImage($id)
    {
        ...
        $product->p_img  = urlencode("http://".$ip_server."/foodapp/public/img/".$product->p_img);
        }
